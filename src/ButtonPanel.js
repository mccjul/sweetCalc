      ...
      <div className="button-panel row">
        <div className="s3 column">
          <div className="s1 row">
            <button className="button s1" data-code="shift+57" data-value="(" onClick={this.onClick}>(</button>
            <button className="button s1" data-code="shift+48" data-value=")" onClick={this.onClick}>)</button>
            <button className="button s1" data-code="shift+54" data-value="^" onClick={this.onClick}>^</button>
          ...
          <div className="s1 row">
            <button className="button s1" data-code="48" data-value="0" onClick={this.onClick}>0</button>
            <button className="button s1" data-code="190" data-value="." onClick={this.onClick}>.</button>
            <button className="button s1" data-code="27" data-value="c" onClick={this.onClick}>C</button>
          </div>
        </div>
